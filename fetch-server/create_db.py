...
def build_sample_db(db):
    ...
    with app.app_context():
        ...
        weather1 = Weather(temperature=70,
                           sunny=True,
                           cloudy=False,
                           rainy=False)
        weather2 = Weather(temperature=75,
                           sunny=True,
                           cloudy=False,
                           rainy=False)
        
        path1 = 'SRID=%d;LINESTRING(-117.236271500587 32.8783077126596, -117.234329581261 32.8786140640161, -117.234061360359 32.8771543804097, -117.233363986015 32.8769291184529)' % utils.get_default_srid()
